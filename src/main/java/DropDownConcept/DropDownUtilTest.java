...
public class DropDownUtilTest {
	...
	public static void main(String[] args) {
		...
		String date = "Feb-16-1999";
		String datVal[] = date.split("-");
		
		DropDownUtil.selectValueFromDropDown(month, datVal[0]);
		DropDownUtil.selectValueFromDropDown(day, datVal[1]);
		DropDownUtil.selectValueFromDropDown(year, datVal[2]);
